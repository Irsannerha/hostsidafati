<div class="row clearfix">
    <div class="col-md-12 col-sm-12">
        <div class="modal fade" id="deleteModal{{ $prestasi->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                        ...
                        <div class="modal-body table-responsive">
                            <div class="pd-20 card-box card-hdr" data-bgcolor="#fff">
                                ...
                                @if (Auth::user()->role == 'superadmin')
                                    <form action="{{ route('superadmin.prestasi.destroy', $prestasi->id) }}" method="POST">
                                @elseif (Auth::user()->role == 'kemahasiswaan')
                                    <form action="{{ route('kemahasiswaan.prestasi.destroy', $prestasi->id) }}" method="POST">
                                @endif
                                        @method('DELETE')
                                        @csrf
