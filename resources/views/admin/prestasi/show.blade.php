    ...
    <div class="modal-dialog modal-sm modal-dialog-scrollable" role="document">
      <div class="modal-content" data-bgcolor="#d0d0d0">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-paperclip" aria-hidden="true"></i> Detail Data Prestasi Mahasiswa</h5>
        ...
        <div class="modal-body table-responsive">
          ...
          <div class="pd-20 card-box card-hdr" data-bgcolor="#fff">
            <dl class="text-content-box">
              ...
              <dd class="custom-dd"><span class="badge badge-success" data-bgcolor="#28354a" style="border-radius: 10px; padding: 0.4rem 0.6rem; font-size: 13px;">{{ $prestasi->jenis_prestasi }}</span></dd>
                  ...
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <div class="card card-box">
                        <img class="card-img" src="{{ asset('assets/foto/' . $foto[0]) }}" alt="Card image">
                      </div>
                    </div>
                    <div class="carousel-item">
                      <div class="card card-box">
                        <img class="card-img" src="{{ asset('assets/foto/' . $foto[1]) }}" alt="Card image">
                      </div>
                    </div>
                    <div class="carousel-item">
                      <div class="card card-box">
                        <img class="card-img" src="{{ asset('assets/foto/' . $foto[2]) }}" alt="Card image">
                      </div>
                    </div>
                  </div>
