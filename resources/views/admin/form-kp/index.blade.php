<x-admin-app>
                    ...
                    <div class="pb-20">
                        <table id="dataTable" class="data-table table stripe hover nowrap">
                            ...
                            <tbody>
                                ...
                                <tr data-status="{{ $kp->status }}">
                                    <td class="table-plus">{{ $loop->iteration }}</td>
                                    <td>{{ $kp->prodi ? $kp->prodi->prodi : '' }}</td>
                                    <td><span class="btn btn-outline-primary btn-lg" style="border-radius: 10px; padding: 0.4rem 0.6rem; font-size: 12px;">{{ $kp->email }}</span></td>
                                    <td>
                                    ...
                                    @include('admin.form-kp.show')
                                    <td>
                                        <div class="table-actions">
                                            <a class="btn btn-xxs btn-primary mr-1" style="border-radius: 15px; padding: 0.2rem 0.5rem; font-size: 0.9rem;" data-color="#fff" data-toggle="modal" data-target="#showModal{{ $kp->id }}">
                                                <i class="icon-copy dw dw-eye"></i> Lihat
                                            </a>
                                            <a href="{{ route('superadmin.form-kp.edit', $kp->id) }}" class="btn btn-xxs btn-primary mr-1" style="border-radius: 15px; padding: 0.2rem 0.5rem; font-size: 0.9rem;" data-color="#fff">
                                                <i class="icon-copy dw dw-edit2"></i> Edit
                                            </a>
                                            <a class="btn btn-xxs btn-primary mr-1" style="border-radius: 15px; padding: 0.2rem 0.5rem; font-size: 0.9rem;" data-color="#fff" data-toggle="modal" data-target="#deleteModal{{ $kp->id }}">
                                                <i class="icon-copy dw dw-delete-3"></i> Hapus
                                            </a>
                                            @include('admin.form-kp.delete')
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
    ...
    function exportToExcel() {
        window.location.href = "{{ url('formkp/export') }}";
    }
</script>
</x-admin-app>
