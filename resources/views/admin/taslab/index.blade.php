            ...
            <div class="min-height-200px">
                ...
                <div class="card-box mb-30">
                    <div class="pd-20">
                        ...
                        <a href="{{ route('pegawai.taslab.create') }}" class="btn btn-primary font-weight-bold"><i class="fa fa-plus"></i> Tambah Data</a>
                        @endif
                    </div>
                    <div class="pb-20">
                                  ...
                                  @include('admin.taslab.show')
                                    <td>
                                        <div class="table-actions">
                                            ...
                                            @elseif (Auth::user()->role == 'pegawai')
                                            <a href="{{ route('pegawai.taslab.edit', $taslab->id) }}" class="btn btn-xxs btn-primary mr-1" style="border-radius: 15px; padding: 0.2rem 0.5rem; font-size: 0.9rem;" data-color="#fff">
                                            @endif
...
<div class="modal fade" id="ImportModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="pd-20 card-box card-hdr">
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <a href="{{ asset('assets/templateImport/template_taslab.xlsx') }}" class="btn btn-primary" download>
                                <i class="fa fa-download"></i> Download
                            </a>
                        </div>
                        <div class="form-group">
                            <form action="{{ route('taslab.import') }}" method="POST" enctype="multipart/form-data">
                                @csrf
    ...
    function exportToExcel() {
        window.location.href = "{{ url('taslab/export') }}";
    }
    </script>
</x-admin-app>
