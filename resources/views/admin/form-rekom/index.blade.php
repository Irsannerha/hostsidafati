<x-admin-app>
                    ...
                    <div class="pb-20">
                        <table id="dataTable" class="data-table table stripe hover nowrap">
                            ...
                            <tbody>
                                ...
                                <tr data-status="{{ $rekom->status }}">
                                    <td class="table-plus">{{ $loop->iteration }}</td>
                                    <td>{{ $rekom->prodi ? $rekom->prodi->prodi : '' }}</td>
                                    <td><span class="btn btn-outline-primary btn-lg" style="border-radius: 10px; padding: 0.4rem 0.6rem; font-size: 12px;">{{ str_replace(',', ', ', $rekom->nama) }}</span></td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="table-actions">
                                            ...
                                            <a class="btn btn-xxs btn-primary mr-1" style="border-radius: 15px; padding: 0.2rem 0.5rem; font-size: 0.9rem;" data-color="#fff" data-toggle="modal" data-target="#deleteModal{{ $rekom->id }}">
                                                <i class="icon-copy dw dw-delete-3"></i> Hapus
                                            </a>
                                    @include('admin.form-rekom.delete')
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
    ...
    function exportToExcel() {
        window.location.href = "{{ url('formrekom/export') }}";
    }
</script>
</x-admin-app>
