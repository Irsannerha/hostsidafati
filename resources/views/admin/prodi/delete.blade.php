<div class="row clearfix">
    <div class="col-md-12 col-sm-12">
        <div class="modal fade" id="deleteModal{{ $prodi->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                            ...
                            <div class="pd-20 card-box card-hdr" data-bgcolor="#fff">
                                ...
                                <div class="modal-body">
                                    <div class="center">
                                        ...
                                        <center><span><small><span class="btn btn-outline-primary btn-lg" style="border-radius: 10px; padding: 0.4rem 0.6rem; font-size: 12px;">{{ $prodi->kapro }}</span></small></span></center>
                                    </div>
                                </div>
                                ...
                                @elseif (Auth::user()->role == 'pegawai')
                                    <form action="{{ route('pegawai.prodi.destroy', $prodi->id) }}" method="POST">
                                @endif
                                        @method('DELETE')
                                        @csrf
