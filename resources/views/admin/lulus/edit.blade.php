              ...
              <div class="row">
                ...
                <div class="col-md-3 col-sm-12">
                  <div class="form-group">
                    ...
                    <select name="tahun_id" class="form-control">
                      ...
                      <option value="{{ $thnid->id }}" {{ $lulus->tahun_id == $thnid->id ? 'selected' : '' }}>{{ $thnid->tahun }}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
                <div class="col-md-3 col-sm-12">
                  <div class="form-group">
                    ...
                    <input type="number" name="september" class="form-control" value="{{ old('september', $lulus->september) }}" placeholder="Masukkan Jumlah Mahasiswa Lulus TS Sept" />
                  </div>
                </div>
                <div class="col-md-3 col-sm-12">
                  <div class="form-group">
                    <label class="font-weight-bold">November</label>
                    <input type="number" name="november" class="form-control" value="{{ old('november', $lulus->november) }}" placeholder="Masukkan Jumlah Mahasiswa Lulus TS Nov" />
                  </div>
                </div>
                <div class="col-md-3 col-sm-12">
                  <div class="form-group">
