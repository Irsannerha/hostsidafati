            ...
            <div class="min-height-200px">
                <div class="page-header">
                    ...
                    <div class="pd-20 card-box mb-30">
                        ...
                        <form action="{{ route('akademik.mhs-ta.update', $mhsta->id) }}" method="POST" enctype="multipart/form-data">
                        @endif
                            @csrf
                            @method('PUT')
                            <div class="row">
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <option value="{{ $thnid->id }}" {{ $thnid->id == $mhsta->ts_id ? 'selected' : '' }}>{{ $thnid->ts }}</option>
                                    @endforeach
                                    </select>
                                </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <option value="{{ $prodi->id }}" {{ $prodi->id == $mhsta->prodi_id ? 'selected' : '' }}>{{ $prodi->prodi }}</option>
                                    @endforeach
                                    </select>
                                </div>
                                </div>
