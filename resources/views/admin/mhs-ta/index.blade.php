        ...
        <div class="card-box mb-30">
          ...
          <div class="pb-20">
            <table class="data-table table stripe hover nowrap">
              ...
              <tbody>
                @foreach ($mhsta->groupBy('tahun_id') as $ta => $items)
                @php
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
                          <div class="modal-content" data-bgcolor="#d0d0d0">
                            <div class="modal-header">
                              <h4 class="modal-title" id="myLargeModalLabel"><i class="fa fa-paperclip" aria-hidden="true"></i> Jumlah Lulusan Mahasiswa Tugas Akhir {{ $tahun->tahun }}/{{ $tahun->tahun + 1 }}</h4>
                                  ...
                                  <table class="table table-striped">
                                    <thead>
                                      <tr>
                                        ...
                                        <th><span class="btn btn-outline-primary btn-lg" style="border-radius: 15px; padding: 0.4rem 0.7rem; font-size: 0.9rem;">{{ $tahun->tahun - 1 }}/{{ $tahun->tahun }}</th></span>
