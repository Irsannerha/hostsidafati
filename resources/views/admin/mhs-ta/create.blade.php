    ...
    <div class="main-container">
        <div class="pd-ltr-20 xs-pd-20-10">
          ...
          <div class="pd-20 card-box mb-30">
            ...
            <hr />
            <br />
            <form action="{{ route('superadmin.mhs-ta.store') }}" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="row">
                ...
                <div class="col-md-3 col-sm-12">
                  <div class="form-group">
                    ...
                    <select name="tahun_id" class="form-control">
                      ...
                      <option value="{{ $thid->id }}">{{ $thid->tahun }}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
                ...
                <div class="col-md-3 col-sm-12">
                  <div class="form-group">
                    ...
                    <input type="number" name="mhs_ta" class="form-control" placeholder="Masukkan Jumlah Lulusan Mahasiswa Tugas Akhir" />
                  </div>
                </div>
                <div class="col-md-12">
