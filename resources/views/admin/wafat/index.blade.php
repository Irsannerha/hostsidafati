        ...
        <div class="card-box mb-30">
          ...
          <div class="pb-20">
            <table class="data-table table stripe hover nowrap">
              ...
              <tbody>
                @foreach ($wafat->groupBy('tahun_id') as $died => $items)
                @php
                ...
                <tr>
                  ...
                  <td><span class="btn btn-success btn-lg" style="border-radius: 10px; padding: 0.4rem 0.6rem; font-size: 14px;">{{ $total[$died-1]->total }}</span></td>
                  <td>
                    <div class="dropdown">
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
                          <div class="modal-content" data-bgcolor="#d0d0d0">
                            <div class="modal-header">
                              <h4 class="modal-title" id="myLargeModalLabel"><i class="fa fa-paperclip" aria-hidden="true"></i> Mahasiswa Wafat TS {{ $tahun->tahun }}/{{ $tahun->tahun + 1 }}</h4>
