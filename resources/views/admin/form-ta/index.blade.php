<x-admin-app>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="title font-weight-bold">
                                <h4>Pengajuan Tugas Akhir Mahasiswa</h4>
                            </div>
                        ...
                        <table id="dataTable" class="data-table table stripe hover nowrap">
                            ...
                            <tbody>
                                ...
                                <tr data-status="{{ $ta->status }}">
                                    ...
                                    <td><span class="btn btn-outline-primary btn-lg" style="border-radius: 10px; padding: 0.4rem 0.6rem; font-size: 12px;">{{ $ta->email }}</span></td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="table-actions">
                                            <a class="btn btn-xxs btn-primary mr-1" style="border-radius: 15px; padding: 0.2rem 0.5rem; font-size: 0.9rem;" data-color="#fff" data-toggle="modal" data-target="#showModal{{ $ta->id }}">
                                                <i class="icon-copy dw dw-eye"></i> Lihat
                                            </a>
                                            <a href="{{ route('superadmin.form-ta.edit', $ta->id) }}" class="btn btn-xxs btn-primary mr-1" style="border-radius: 15px; padding: 0.2rem 0.5rem; font-size: 0.9rem;" data-color="#fff">
                                                <i class="icon-copy dw dw-edit2"></i> Edit
                                            </a>
                                            <a class="btn btn-xxs btn-primary mr-1" style="border-radius: 15px; padding: 0.2rem 0.5rem; font-size: 0.9rem;" data-color="#fff" data-toggle="modal" data-target="#deleteModal{{ $ta->id }}">
    ...
    function exportToExcel() {
        window.location.href = "{{ url('formta/export') }}";
    }
</script>
</x-admin-app>
