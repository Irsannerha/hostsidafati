...
<div class="modal fade" id="ImportModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="pd-20 card-box card-hdr">
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <a href="{{ asset('assets/templateImport/template_pejabat.xlsx') }}" class="btn btn-primary" download>
                                <i class="fa fa-download"></i> Download
                            </a>
                        </div>
                        <div class="form-group">
                            <form action="{{ route('pejabat.import') }}" method="POST" enctype="multipart/form-data">
                                @csrf
 ...
 <!-- End Import Modal -->
    ...
    function exportToExcel() {
        window.location.href = "{{ url('pejabat/export') }}";
    }
</script>
    <!-- Sweet Alert -->
