  ...
  <!-- Large modal Detail -->
  <!-- Modal -->
  <div class="modal fade" id="showModal{{ $dosbel->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-body table-responsive">
          ...
          <div class="pd-20 card-box card-hdr" data-bgcolor="#fff">
            <dl class="text-content-box">
              <dt>Program Studi</dt>
              <dd>{{ $dosbel->prodi->prodi }}</dd>

              <dt>Nama</dt>
              <dd>{{ $dosbel->nama }}</dd>

              <dt>NIP/NRK</dt>
              <dd>{{ $dosbel->nip_nrk }}</dd>
              ...
              <dt>Tempat Studi</dt>
              <dd>{{ $dosbel->tempat_studi}}</dd>

              <dt>Jenis Beasiswa</dt>
              <dd>{{ $dosbel->jenis_beasiswa}}</dd>

              <dt>Mulai Tugas Belajar</dt>
              <dd>
                <?php
                $bulan = ['January' => 'Januari', 'February' => 'Februari', 'March' => 'Maret', 'April' => 'April', 'May' => 'Mei', 'June' => 'Juni', 'July' => 'Juli', 'August' => 'Agustus', 'September' => 'September', 'October' => 'Oktober', 'November' => 'November', 'December' => 'Desember'];
                $mulai_tubel = \Carbon\Carbon::parse($dosbel->mulai_tubel);
              ...
              <dd>
                <?php
                $bulan = ['January' => 'Januari', 'February' => 'Februari', 'March' => 'Maret', 'April' => 'April', 'May' => 'Mei', 'June' => 'Juni', 'July' => 'Juli', 'August' => 'Agustus', 'September' => 'September', 'October' => 'Oktober', 'November' => 'November', 'December' => 'Desember'];
                $selesai_tubel = \Carbon\Carbon::parse($dosbel->selesai_tubel);
              ...
              <dd>
                <?php
                $bulan = ['January' => 'Januari', 'February' => 'Februari', 'March' => 'Maret', 'April' => 'April', 'May' => 'Mei', 'June' => 'Juni', 'July' => 'Juli', 'August' => 'Agustus', 'September' => 'September', 'October' => 'Oktober', 'November' => 'November', 'December' => 'Desember'];
                $mulai_perpanjangan = \Carbon\Carbon::parse($dosbel->mulai_perpanjangan);
                $bulan_indo = str_replace(array_keys($bulan), array_values($bulan), $mulai_perpanjangan->format('F'));
                echo $mulai_perpanjangan->format('d') . ' ' . $bulan_indo . ' ' . $mulai_perpanjangan->format('Y');
                ?>
              </dd>
              ...
              <dd>
                <?php
                $bulan = ['January' => 'Januari', 'February' => 'Februari', 'March' => 'Maret', 'April' => 'April', 'May' => 'Mei', 'June' => 'Juni', 'July' => 'Juli', 'August' => 'Agustus', 'September' => 'September', 'October' => 'Oktober', 'November' => 'November', 'December' => 'Desember'];
                $selesai_perpanjangan = \Carbon\Carbon::parse($dosbel->selesai_perpanjangan);
                $bulan_indo = str_replace(array_keys($bulan), array_values($bulan), $selesai_perpanjangan->format('F'));
                echo $selesai_perpanjangan->format('d') . ' ' . $bulan_indo . ' ' . $selesai_perpanjangan->format('Y');
                ?>
              </dd>

              <dt>Keterangan</dt>
              <dd>{{ $dosbel->keterangan }}</dd>
            </dl>
          </div>
          <!-- Akhir box -->
        </div>
