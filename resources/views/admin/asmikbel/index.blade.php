            ...
            <div class="min-height-200px">
                ...
                <div class="card-box mb-30">
                    <div class="pd-20">
                        ...
                        <a href="{{ route('pegawai.asmikbel.create') }}" class="btn btn-primary font-weight-bold"><i class="fa fa-plus"></i> Tambah Data</a>
                        @endif
                    </div>
                    <div class="pb-20">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-actions">
                                            ...
                                            @elseif (Auth::user()->role == 'pegawai')
                                            <a href="{{ route('pegawai.asmikbel.edit', $asmikbel->id) }}" class="btn btn-xxs btn-primary mr-1" style="border-radius: 15px; padding: 0.2rem 0.5rem; font-size: 0.9rem;" data-color="#fff">
                                            @endif
...
<div class="modal fade" id="ImportModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="pd-20 card-box card-hdr">
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <a href="{{ asset('assets/templateImport/template_asmikbel.xlsx') }}" class="btn btn-primary" download>
                                <i class="fa fa-download"></i> Download
                            </a>
                        </div>
                        <div class="form-group">
                            <form action="{{ route('asmikbel.import') }}" method="POST" enctype="multipart/form-data">
                                @csrf
 ...
 <!-- End Import Modal -->
    ...
    function exportToExcel() {
        window.location.href = "{{ url('asmikbel/export') }}";
    }
    </script>
