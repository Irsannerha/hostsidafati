                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="title font-weight-bold">
                                <h4>Pengajuan Pengantar Wawancara Mahasiswa</h4>
                            </div>
                    ...
                    <div class="pb-20">
                        <table id="dataTable" class="data-table table stripe hover nowrap">
                            ...
                            <tbody>
                                ...
                                <tr data-status="{{ $wcr->status }}">
                                    <td class="table-plus">{{ $loop->iteration }}</td>
                                    <td>{{ $wcr->prodi ? $wcr->prodi->prodi : '' }}</td>
                                    <td><span class="btn btn-outline-primary btn-lg" style="border-radius: 10px; padding: 0.4rem 0.6rem; font-size: 12px;">{{ str_replace(',', ', ', $wcr->nama) }}</span></td>
                                    <td>
                                    ...
                                    @include('admin.form-wcr.show')
                                    <td>
                                        <div class="table-actions">
                                            <a class="btn btn-xxs btn-primary mr-1" style="border-radius: 15px; padding: 0.2rem 0.5rem; font-size: 0.9rem;" data-color="#fff" data-toggle="modal" data-target="#showModal{{ $wcr->id }}">
                                                <i class="icon-copy dw dw-eye"></i> Lihat
                                            </a>
                                            <a href="{{ route('superadmin.form-wcr.edit', $wcr->id) }}" class="btn btn-xxs btn-primary mr-1" style="border-radius: 15px; padding: 0.2rem 0.5rem; font-size: 0.9rem;" data-color="#fff">
                                                <i class="icon-copy dw dw-edit2"></i> Edit
                                            </a>
                                            <a class="btn btn-xxs btn-primary mr-1" style="border-radius: 15px; padding: 0.2rem 0.5rem; font-size: 0.9rem;" data-color="#fff" data-toggle="modal" data-target="#deleteModal{{ $wcr->id }}">
                                                <i class="icon-copy dw dw-delete-3"></i> Hapus
                                            </a>
                                    @include('admin.form-wcr.delete')
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
