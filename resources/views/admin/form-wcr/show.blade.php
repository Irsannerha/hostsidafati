...
<!-- Modal Lihat -->
<div class="modal fade" id="showModal{{ $wcr->id }}" tabindex="-1" role="dialog" aria-labelledby="showModalLabel{{ $wcr->id }}" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
        <div class="modal-content" data-bgcolor="#d0d0d0">
            <div class="modal-header">
                <h5 class="modal-title" id="showModalLabel{{ $wcr->id }}"><i class="fa fa-paperclip" aria-hidden="true"></i> Detail Data Pengajuan Pengantar Wawancara</h5>
            ...
            <div class="modal-body table-responsive">
                <div class="pd-20 card-box card-hdr" data-bgcolor="#fff">
                    <dl class="text-content-box">
                        <dt>Program Studi</dt>
                        <dd class="custom-dd">{{ $wcr->Prodi ? $wcr->Prodi->prodi : '' }}</dd>

                        <dt>Nama</dt>
                        <dd class="custom-dd">{{ str_replace(',', ', ', $wcr->nama) }}</dd>

                        <dt>NIM</dt>
                        <dd class="custom-dd">{{ str_replace(',', ', ', $wcr->nim) }}</dd>

                        <dt>Instansi</dt>
                        <dd class="custom-dd">{{ $wcr->instansi }}</dd>

                        <dt>Alamat Instansi</dt>
                        <dd class="custom-dd">{{ $wcr->alamat_instansi }}</dd>
