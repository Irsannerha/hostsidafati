                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12 col-md-12 text-center">
                                <div class="title-heading mt-4">
                                    ...
                                    Selamat datang di Formulir Tanda Bukti Penerimaan Berkas Fakultas Teknologi Industri ITERA. Formulir ini adalah Bukti mendata dokumen yang sudah diterima.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="clients p-4 bg-gradient-1">
                    <div class="card-body">
                        <div class="col-md-12">
                            ...
                            <br>
                            <form action="{{ route('formbukrim.store') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="card-box">
                                            <div class="mb-10">
                                                <input type="text" value="" data-role="tagsinput" placeholder="Nama" name="nama_dok" id="nama_dok" />
                                            </div>
                                        </div>
                                        <small class="text-dark font-5" style="margin-top: -10px; display: block;">*Isi Nama Anda/Bila nama lebih dari satu tulis kan namanya satu satu, lalu Inputkan</small>
                                    </div>
                                      <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Masukkan Jenis Berkasnya" name="jenis_berkas" id="jenis_berkas"></input>
                                        </div>
                                        <small class="text-dark font-5" style="margin-top: -10px; display: block;">*Isi Jenis Berkas </small>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="jumlah_dok">Jumlah Dokumen</label>
                                            <input class="form-control" placeholder="Masukkan Jumlah Dokumen" name="jumlah_dok" id="jumlah_dok"></input>
                                        </div>
                        ...
                        <div class="notification">
                            <div class="notification__message">
                                ...
                                <p>👋 Halo Mahasiswa ITERA!. Selamat datang di SIDAFATI! ini adalah Halaman Formulir Tanda Bukti Penerimaan Berkas!. Silahkan Diisi ya..</p>
