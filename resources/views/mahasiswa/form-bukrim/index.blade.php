                            ...
                            <tbody>
                                @foreach ($formbukrim as $bukrim)
                                    <tr>
                                        ...
                                        <td>{{ $bukrim->nama }}</td>
                                        @include('mahasiswa.form-bukrim.show')
                                        <td>
                                            <div class="table-actions">
                                                <a class="btn btn-xxs btn-primary mr-1"
                                                    ...
                                                    data-target="#showModal{{ $bukrim->id }}">
                                                    <i class="icon-copy dw dw-eye"></i> Lihat
                                                </a>
                                                <a href="{{ route('mahasiswa.form-bukrim.edit', $bukrim->id) }}"
                                                ...
                                                <a class="btn btn-xxs btn-primary mr-1"
                                                    style="border-radius: 15px; padding: 0.2rem 0.5rem; font-size: 0.9rem;"
                                                    data-color="#fff" data-toggle="modal"
                                                    data-target="#deleteModal{{ $bukrim->id }}">
                                                    <i class="icon-copy dw dw-delete-3"></i> Hapus
                                                </a>
                                                @include('mahasiswa.form-bukrim.delete')
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
