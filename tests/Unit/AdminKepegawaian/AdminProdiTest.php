...
class AdminProdiTest extends TestCase
{
    ...
    /** @test */
    public function adminPegawai_mengakses_halaman_index_prodi()
    {
        ...
        $response = $this->get('/pegawai/prodi'); // Mengirim permintaan HTTP GET ke URL '/pegawai/prodi'
    ...
    /** @test */
    public function adminPegawai_menambah_data_prodi()
    {
        // Buat pengguna dengan peran (role) dan status yang diperlukan
        $pegawai = User::factory()->create([
            'role' => 'pegawai', // Set role pengguna sebagai 'pegawai'
        ...
        $response = $this->post('/pegawai/prodi', [
        ...
        $response->assertRedirect('/pegawai/prodi');
    ...
    /** @test */
    public function adminPegawai_mengedit_data_prodi()
    {
        // Buat user pegawai
        $pegawai = User::factory()->create([
            'role' => 'pegawai',
        ...
        $response = $this->put("/pegawai/prodi/{$prodi->id}", [
            'prodi' => 'Teknik Mesin',
    ...
    /** @test */
    public function adminPegawai_melihat_data_prodi()
    {
        // Buat user pegawai
        $pegawai = User::factory()->create([
            'role' => 'pegawai',
        ...
        $response = $this->get("/pegawai/prodi/{$prodi->id}");
    ...
    /** @test */
    public function adminPegawai_menghapus_data_prodi()
    {
        // Buat user pegawai
        $pegawai = User::factory()->create([
            'role' => 'pegawai',
        ...
        $response = $this->delete("/pegawai/prodi/{$prodi->id}");
    ...
    /** @test */
    public function adminPegawai_mengexport_data_prodi()
    {
     ...
     /** @test */
    public function adminPegawai_mengimport_data_prodi()
    {
    ...
    /** @test */
    public function adminPegawai_mendownload_template_excel_prodi()
    {
        // Buat user pegawai
        $pegawai = User::factory()->create([
            'role' => 'pegawai',
