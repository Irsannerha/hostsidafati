...
class DosbelTest extends TestCase
{
    use RefreshDatabase;

    /**
     * Membuat pengguna superadmin dan Admin untuk keperluan pengujian.
     */
    ...
    /** @test */
    public function superadmin_mengakses_halaman_index_dosbel()
    {
        ...
        $response = $this->get('/superadmin/dosbel'); // Mengirim permintaan HTTP GET ke URL '/superadmin/dosbel'
    ...
    /** @test */
    public function superadmin_menambah_data_dosbel()
    {
        // Buat pengguna dengan peran (role) dan status yang diperlukan
        $superadmin = User::factory()->create([
            'role' => 'superadmin', // Set role pengguna sebagai 'Superadmin'
        ...
        // Membuat data dosbel
        $response = $this->post('/superadmin/dosbel', [
            'prodi_id' => '1',
            'nama' => 'Khyze',
            'nip_nrk' => '1234567890',
            'status' => 'aktif',
    ...
    /** @test */
    public function superadmin_mengedit_data_dosbel()
    {
        // Buat pengguna dengan peran (role) dan status yang diperlukan
        $superadmin = User::factory()->create([
            'role' => 'superadmin', // Set role pengguna sebagai 'Superadmin'
        ...
        // Mengirim permintaan HTTP POST ke URL '/superadmin/dosbel/$dosbel->id' untuk mengedit data dosbel
        $response = $this->put("/superadmin/dosbel/$dosbel->id", [
            'prodi_id' => '1',
            'nama' => 'Khyze',
            'nip_nrk' => '1234567890',
            'status' => 'aktif',
        ...
        $response->assertRedirect('/superadmin/dosbel'); // Memastikan bahwa data dosbel berhasil diubah dengan status respons 302 (redirect)
    ...
    /** @test */
    public function superadmin_melihat_data_dosbel()
    {
        ...
        $response = $this->get("/superadmin/dosbel/{$dosbel->id}");
    ...
    /** @test */
    public function superadmin_menghapus_data_dosbel()
    {
        // Buat user superadmin
        $superadmin = User::factory()->create([
            'role' => 'superadmin',
    ...
    /** @test */
    public function superadmin_mengimport_data_dosbel()
    {
    ...
    /** @test */
    public function superadmin_mendownload_template_excel_dosbel()
    {
        // Buat user superadmin
        $superadmin = User::factory()->create([
            'role' => 'superadmin',
