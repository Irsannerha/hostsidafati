...
class KeluarImport implements ToModel, WithHeadingRow, WithStartRow
{
    public function model(array $row)
    {
        ...
        Log::info('Row is valid. Creating Keluar entry.');

        return new Keluar([
            'prodi_id' => $prodi->id,
            'ts_id' => $tahun->id,
            'mhs_keluar_genap' => $row['mhs_keluar_genap'],
            'mhs_keluar_ganjil' => $row['mhs_keluar_ganjil'],
        ]);
    }
